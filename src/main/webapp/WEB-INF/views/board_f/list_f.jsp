            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                ...
                <button id="regBtn" type="button" class="btn btn-sm btn-primary">글쓰기</button></h5>
                  ...
                  <div class='row'>
                	...
                	<form id='searchForm' action="/board_f/list_f" method="get">
                		<select name='type'>
                ...
                <div class="table-responsive text-nowrap">
             	...
             	<div class="demo-inline-spacing">
              		 ...
              		 <form id='actionForm' action="/board_f/list_f" method='get'>
              		 	<input type='hidden' name='pageNum' value='${pageMaker.cri.pageNum }'>
              		 	<input type='hidden' name='amount' value='${pageMaker.cri.amount }'>
              ...
              <script type="text/javascript">
              	...
              	$('#regBtn').on("click",function(){
              		self.location="/board_f/register";
              	});
              	...
              	$(".move").on("click",function(e){
              		...
              		actionForm.attr("action","/board_f/get");
              		actionForm.submit();
              	});
