			...
			<div class="panel-body">				
				...
				<div class='uploadResult'>
					<ul>
                      ...
                      <form id="operForm" action="/board_h/modify" method="get">
               	...
               	<script>
                	$(document).ready(function(){
                		...
                		$("button[data-oper='modify']").on("click",function(e){
                			operForm.attr("action","/board_h/modify").submit();
                		});
                		
                		$("button[data-oper='list']").on("click",function(e){
                			operForm.find("#bno").remove();
							
                			operForm.attr("action","/board_h/list_h");                			
...
$(document).ready(function(){
	(function(){
		...
		$.getJSON("/board_h/getAttachList",{bno:bno},function(arr){
			console.log(arr);
